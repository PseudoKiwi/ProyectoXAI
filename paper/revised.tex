...
\and
\IEEEauthorblockN{2\textsuperscript{nd} Fiorella Cravero}
\IEEEauthorblockA{\textit{dept. name of organization (of Aff.)} \\
\textit{Universidad Católica del Uruguay}\\
Montevideo, Uruguay \\
email address or ORCID}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Matías Di Martino}
\IEEEauthorblockA{\textit{dept. name of organization (of Aff.)} \\
\textit{Universidad Católica del Uruguay}\\
Montevideo, Uruguay \\
email address or ORCID}
...
\hline
Dataset & Model & Acc. & F1 & $D_{KL_{T=1}}$ & $D_{KL_{T=2}}$ \\ \hline
\textbf{IMDb} & $P$ & $\mathbf{0.954}$ & $\mathbf{0.954}$ & -- & -- \\
\textbf{IMDb} & $B$ & $0.857$ & $0.857$ & $2.847$ & $1.686$ \\
\textbf{IMDb} & $S_0$ & $0.813$ & $0.810$ & $\mathbf{0.103}$ & $\underline{0.131}$ \\
\textbf{IMDb} & $S_1$ & $0.798$ & $0.797$ & $\underline{0.104}$ & $\mathbf{0.127}$ \\
\textbf{IMDb} & $S_2$ & $\underline{0.867}$ & $\underline{0.867}$ & $0.111$ & $0.192$ \\ \hline
\textbf{AG News} & $P$ & $0.848$ & $0.847$ & -- & -- \\
\textbf{AG News} & $B$ & $\mathbf{0.886}$ & $\mathbf{0.886}$ & $2.080$ & $1.784$ \\
\textbf{AG News} & $S_0$ & $\underline{0.883}$ & $\underline{0.883}$ & $0.629$ & $0.418$ \\
\textbf{AG News} & $S_1$ & $0.878$ & $0.878$ & $\underline{0.278}$ & $\mathbf{0.228}$ \\
\textbf{AG News} & $S_2$ & $0.880$ & $0.880$ & $\mathbf{0.247}$ & $\underline{0.246}$ \\ \hline
\end{tabular}
\label{tab:perf}
\end{table}
...
\hline
\multirow{2}{*}{Dataset} & \multirow{2}{*}{Model} & \multicolumn{4}{c|}{LIME} & \multicolumn{3}{c|}{SHAP} & \multicolumn{3}{c|}{IG} \\
\cline{3-12}
 & & Jac.@10 & $\rho$ & Faithf. & Stab. & Jac.@10 & $\rho$ & Faithf. & Jac.@10 & $\rho$ & Faithf. \\ \hline
\textbf{IMDb} & $P$ & -- & -- & $0.172$ & $0.548$ & -- & -- & $\underline{0.118}$ & -- & -- & $0.010$ \\
\textbf{IMDb} & $B$ & $\underline{0.183}$ & $\underline{0.248}$ & $0.083$ & $0.587$ & $0.117$ & $0.239$ & $0.025$ & $\underline{0.793}$ & $-0.005$ & $0.010$ \\
\textbf{IMDb} & $S_0$ & $0.170$ & $0.216$ & $\underline{0.202}$ & $\underline{0.684}$ & $\underline{0.123}$ & $0.238$ & $0.093$ & $0.778$ & $\underline{0.028}$ & $\mathbf{0.085}$ \\
\textbf{IMDb} & $S_1$ & $0.136$ & $0.189$ & $0.177$ & $0.611$ & $0.096$ & $\underline{0.245}$ & $0.058$ & $\mathbf{0.814}$ & $0.010$ & $\underline{0.025}$ \\
\textbf{IMDb} & $S_2$ & $\mathbf{0.212}$ & $\mathbf{0.299}$ & $\mathbf{0.267}$ & $\mathbf{0.710}$ & $\mathbf{0.176}$ & $\mathbf{0.333}$ & $\mathbf{0.120}$ & $0.787$ & $\mathbf{0.039}$ & $0.019$ \\
\hline
\textbf{AG News} & $P$ & -- & -- & $0.138$ & $\mathbf{0.773}$ & -- & -- & $\mathbf{0.002}$ & -- & -- & $0.053$ \\
\textbf{AG News} & $B$ & $0.336$ & $\underline{0.321}$ & $0.306$ & $0.668$ & $0.315$ & $\underline{0.269}$ & $-0.002$ & $\mathbf{0.890}$ & $\underline{0.021}$ & $0.067$ \\
\textbf{AG News} & $S_0$ & $\underline{0.347}$ & $0.279$ & $\underline{0.402}$ & $0.638$ & $\underline{0.317}$ & $\mathbf{0.274}$ & $\underline{0.000}$ & $0.883$ & $\mathbf{0.040}$ & $\underline{0.162}$ \\
\textbf{AG News} & $S_1$ & $0.341$ & $0.306$ & $0.299$ & $0.614$ & $\mathbf{0.320}$ & $0.267$ & $\underline{0.000}$ & $0.876$ & $-0.036$ & $0.138$ \\
\textbf{AG News} & $S_2$ & $\mathbf{0.358}$ & $\mathbf{0.342}$ & $\mathbf{0.431}$ & $\underline{0.688}$ & $0.311$ & $0.262$ & $-0.000$ & $\underline{0.888}$ & $0.013$ & $\mathbf{0.340}$ \\ \hline
\end{tabular}
...
\caption{Cosine similarity, Frobenius distance, $D_{JS}$, $PR$, and $ER$ vs.\ teacher $P_{avg}$ across all $11$ layers, both datasets ($B$, $S_0$, $S_1$, $S_2$; rows: \textbf{IMDb}, \textbf{AG News}).}
